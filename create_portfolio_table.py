#!/usr/bin/env python3
"""
Create portfolio table with specific columns as requested
"""
...
def create_portfolio_table():
    try:
        ...
        # Create portfolio table with requested columns
        ...
        cursor.executemany('INSERT INTO portfolio (asset_name, category, current_value, purchase_price) VALUES (?, ?, ?, ?)', sample_investments)
        ...
        print(f"✅ Portfolio table created successfully!")
        ...
        # Calculate totals
        cursor.execute('SELECT category, SUM(current_value) as total_value, SUM(purchase_price) as total_cost FROM portfolio GROUP BY category')
        ...
        cursor.execute('SELECT SUM(current_value) as total_value, SUM(purchase_price) as total_cost FROM portfolio')
